...
@section('header', 'Edit Audit Keuangan')
@section('content')
<div class="mb-6">
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
    ...
    <form action="{{ route('admin.tata-kelola.financial-report.update', $annualReport->id ?? $financialReport->id ?? $auditIso->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-4">
