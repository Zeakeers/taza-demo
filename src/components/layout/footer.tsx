          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-14">
            ...
            <div className="md:col-span-4 flex flex-col gap-6">
              ...
              <div className="flex gap-4 mt-2">
                <a
                  href="#"
                  aria-label="Telegram"
                  className="w-10 h-10 rounded-full bg-white shadow-sm border border-[#7fc248] flex items-center justify-center text-[#7fc248] hover:text-[#2AABEE] hover:border-[#2AABEE] hover:shadow-md transition-all duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="#"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-full bg-white shadow-sm border border-[#7fc248] flex items-center justify-center text-[#7fc248] hover:text-[#0077b5] hover:border-[#0077b5] hover:shadow-md transition-all duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            <div className="md:col-span-3 flex flex-col pt-2">
              ...
              <div className="flex flex-col gap-4">
                <a
                  href="https://wa.me/6282230099009"
                  target="_blank"
