    ...
    <div className="bg-white min-h-screen overflow-hidden relative">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-16 md:py-24">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between mb-16 gap-8 relative items-start">
          ...
          <div className="w-full md:w-[40%] static md:sticky top-0 md:top-[300px] flex flex-col justify-center md:justify-start items-center md:items-start mb-10 md:mb-0">
          ...
          <div className="w-full md:w-[55%] flex flex-col justify-end items-end md:items-end">
            <Image
