    ...
    <main className="min-h-screen bg-[#FDFDFD] font-poppins pb-20">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-12">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center text-sm font-medium text-gray-500">
            ...
            <Link href="/artikel" className="hover:text-[#7FC248] transition-colors">Artikel</Link>
            <span className="mx-2">/</span>
            <span className="text-gray-900 truncate max-w-[200px] md:max-w-xs">{artikel.judul}</span>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 pt-12 border-t-2 border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link href="/artikel" className="group flex flex-col sm:flex-row gap-4 bg-white rounded-2xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-all">
