...
export default function QurbanPage() {
    ...
    const runAnimation = async () => {
      ...
      const startWalk = (speed = 120) => {
        const timer = setInterval(() => {
          ...
          setAnim((p) => ({
            ...p,
            goatImg: p.goatImg.includes("jalan1")
              ? "/images/kambing/jalan 2.png"
              : "/images/kambing/jalan1.png",
          }));
        }, speed);
      ...
      setTimeout(() => {
        if (isMounted) setAnimateHero(true);
      }, 100);
  ...
  return (
    <div className="w-full flex flex-col bg-white overflow-x-hidden font-[var(--font-poppins)]">
      <style
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl px-4 py-8 md:px-8 justify-center md:justify-end items-center h-full mt-10 md:mt-0">
          <div className="w-full md:w-[460px] relative mt-4 md:mt-0">
            ...
            >
              {/* Taza Badge */}
              <div
                className={`absolute -top-6 -left-6 md:-top-7 md:-left-7 z-20 ${animateHero ? "badge-bounce" : "opacity-0"}`}
              >
              ...
              <div className="px-6 pt-10 pb-6 md:px-8 text-center">
                <h1 className="font-[var(--font-poppins)] text-[22px] md:text-2xl font-bold leading-tight text-black">
                  Salurkan Sedekahmu Untuk Layanan Ambulan Gratis
                </h1>
                <p className="mt-4 text-[14px] md:text-[15px] leading-relaxed text-zinc-700">
                  Bantu Kami Memberikan Fasilitas Kesehatan Layak &amp; Gratis
                ...
                <div className="relative inline-block mt-7 mb-2">
                  ...
                  >
                    <div className="relative rounded-sm bg-[#7FC248] px-5 py-2 md:px-6 md:py-2.5">
                      <div className="relative z-10 inline-flex items-center gap-2 font-semibold font-[var(--font-poppins)] text-white text-[15px] md:text-[16px]">
      ...
      <section className="w-full bg-white px-4 py-16 md:py-24">
        <div className="mx-auto max-w-5xl flex flex-col items-center">
          <h2 className="text-2xl md:text-[32px] font-bold font-[var(--font-poppins)] text-[#222520] mb-4 text-center">
          ...
          <p className="text-[14px] md:text-[16px] text-zinc-700 text-center max-w-4xl leading-relaxed mb-14 md:mb-20 px-2 md:px-8">
            Bagaimana Anda tahu sedekah qurban Anda benar-benar sampai kepada
            yang membutuhkan? Kami memastikan setiap amanah tersalurkan dengan
            transparan, terdokumentasi, dan memberi dampak nyata bagi mereka
            yang jarang merasakan nikmatnya daging qurban.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full px-2">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="h-[80px] w-[80px] md:h-[90px] md:w-[90px] mb-6 flex items-center justify-center">
                <div
                  className="w-[60px] h-[60px] bg-[#e0c29a]"
                  style={{
                    WebkitMaskImage:
                      'url("/images/icon/Successful Delivery.svg")',
                    WebkitMaskSize: "contain",
                    WebkitMaskRepeat: "no-repeat",
                    WebkitMaskPosition: "center",
                    maskImage: 'url("/images/icon/Successful Delivery.svg")',
                    maskSize: "contain",
              ...
              <h3 className="text-[17px] md:text-xl font-bold font-[var(--font-poppins)] text-black mb-3">
                Tersalurkan Sepenuhnya
              </h3>
              <p className="text-[13px] md:text-[14px] text-zinc-600 leading-relaxed max-w-[280px]">
                Sedekah qurban Anda disalurkan langsung kepada masyarakat
                dhuafa, pelosok desa, dan wilayah minim pequrban
              </p>
            </div>
            {/* Item 2 */}
            <div className="flex flex-col items-center text-center">
              <div className="h-[80px] w-[80px] md:h-[90px] md:w-[90px] mb-6 flex items-center justify-center">
                <div
                  className="w-[60px] h-[60px] bg-[#e0c29a]"
                  style={{
                    WebkitMaskImage: 'url("/images/icon/Check File.svg")',
                    WebkitMaskSize: "contain",
                    WebkitMaskRepeat: "no-repeat",
                    WebkitMaskPosition: "center",
                    maskImage: 'url("/images/icon/Check File.svg")',
                    maskSize: "contain",
                    maskRepeat: "no-repeat",
                    maskPosition: "center",
                  }}
              ...
              <p className="text-[13px] md:text-[14px] text-zinc-600 leading-relaxed max-w-[280px]">
                Anda akan menerima dokumentasi berupa foto, laporan, dan cerita
                penyaluran
              </p>
            </div>
            {/* Item 3 */}
            <div className="flex flex-col items-center text-center">
              <div className="h-[80px] w-[80px] md:h-[90px] md:w-[90px] mb-6 flex items-center justify-center">
                <div
                  ...
                  style={{
                    WebkitMaskImage:
                      'url("/images/icon/Worldwide Location.svg")',
                    WebkitMaskSize: "contain",
                    WebkitMaskRepeat: "no-repeat",
                    WebkitMaskPosition: "center",
                    maskImage: 'url("/images/icon/Worldwide Location.svg")',
                    maskSize: "contain",
                    maskRepeat: "no-repeat",
                    maskPosition: "center",
                  }}
              ...
              <h3 className="text-[17px] md:text-xl font-bold font-[var(--font-poppins)] text-black mb-3">
                Berdampak Luas &amp; Bermakna
              </h3>
              <p className="text-[13px] md:text-[14px] text-zinc-600 leading-relaxed max-w-[280px]">
                Sedekah qurban Anda menghadirkan senyum, menguatkan ukhuwah, dan
                menjadi seutas kebaikan yang terus mengalir
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-12 md:gap-y-10">
            ...
            <div className="relative w-full aspect-[4/3] group overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-8 bg-white/95 backdrop-blur-sm px-6 py-4 rounded-sm shadow-md z-10 transition-all duration-300 transform group-hover:-translate-y-1">
                <h3 className="text-[17px] md:text-lg font-[var(--font-poppins)] text-black mb-2 flex items-center justify-between font-bold">
                  Qurban Mudah &amp; Terjangkau{" "}
                  <span className="text-xl ml-2">&rarr;</span>
                </h3>
                <p className="text-[12px] md:text-[13px] text-zinc-600 leading-relaxed">
                  Qurban terbaik dengan harga terjangkau, tetap sesuai syariat
            ...
            <div className="relative w-full aspect-[4/3] group overflow-hidden">
              <div className="absolute inset-0 z-0">
                <Image
                  src="/images/gambardetaile/qurban pelosok desa 2.png"
                  alt="Qurban pelosok desa 2"
                  fill
                  className="object-cover rounded-sm transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              ...
              <div className="absolute bottom-4 left-4 right-8 bg-white/95 backdrop-blur-sm px-6 py-4 rounded-sm shadow-md z-10 transition-all duration-300 transform group-hover:-translate-y-1">
                <h3 className="text-[17px] md:text-lg font-[var(--font-poppins)] text-black mb-2 flex items-center justify-between font-bold">
                  Qurban Terbaik Pilihan Anda{" "}
                  <span className="text-xl ml-2">&rarr;</span>
                </h3>
                <p className="text-[12px] md:text-[13px] text-zinc-600 leading-relaxed">
                  Qurban berkualitas tinggi. Wujudkan qurban istimewa dengan
                  niat yang lebih luas.
                </p>
              </div>
            </div>
            ...
            <div className="relative w-full aspect-[4/3] group overflow-hidden">
              <div className="absolute inset-0 z-0">
                <Image
                  src="/images/gambardetaile/qurban indonesia timur.png"
                  alt="Qurban Indonesia Timur"
                  fill
                  className="object-cover rounded-sm transition-transform duration-500 group-hover:scale-105"
                />
              </div>
              ...
              <div className="absolute bottom-4 left-4 right-8 bg-white/95 backdrop-blur-sm px-6 py-4 rounded-sm shadow-md z-10 transition-all duration-300 transform group-hover:-translate-y-1">
                <h3 className="text-[17px] md:text-lg font-[var(--font-poppins)] text-black mb-2 flex items-center justify-between font-bold">
                  Sebar Qurban Hingga Pelosok{" "}
                  <span className="text-xl ml-2">&rarr;</span>
                </h3>
                <p className="text-[12px] md:text-[13px] text-zinc-600 leading-relaxed">
                  Salurkan qurban Anda ke wilayah minim perkotaan di Indonesia
                  Timur
                </p>
              </div>
            </div>
            ...
            <div className="relative w-full aspect-[4/3] group overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-8 bg-white/95 backdrop-blur-sm px-6 py-4 rounded-sm shadow-md z-10 transition-all duration-300 transform group-hover:-translate-y-1">
                ...
                <p className="text-[12px] md:text-[13px] text-zinc-600 leading-relaxed">
                  Qurban Anda menjadi penguat dan penghibur bagi saudara kita di
                  Palestina
                </p>
              </div>
            </div>
