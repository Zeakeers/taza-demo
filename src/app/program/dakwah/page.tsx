  ...
  return (
    <main className="min-h-screen w-full bg-white overflow-x-hidden font-poppins">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 flex justify-center md:justify-end">
          ...
          <div className="bg-white rounded-2xl md:rounded-md w-full sm:max-w-[420px] p-5 sm:p-6 md:p-8 lg:p-10 relative border border-green-50 shadow-[15px_-10px_30px_rgba(127,194,72,0.25)] md:shadow-[25px_-15px_40px_rgba(127,194,72,0.25)] mt-12 md:mt-0">
            ...
            <ul className="space-y-3 md:space-y-4 mb-8 md:mb-10 ml-2 md:ml-8">
              {["Da'i Pedalaman", "Sebar Al-Quran", "Pembinaan Mualaf"].map(
                (item, idx) => (
      ...
      <section className="w-full pt-16 pb-12 px-4 md:px-12 bg-white flex justify-center text-center">
        <div className="max-w-4xl w-full">
          ...
          <p className="text-zinc-800 text-sm md:text-lg leading-relaxed max-w-4xl font-medium mx-auto">
            Program Dakwah Taman Zakat adalah Inisiatif yang bertujuan untuk
            menyebarkan syiar Islam, membina spiritual masyarakat terutama di
            pedalaman, serta mendistribusikan sarana ibadah seperti Al-Quran dan
            pembangunan masjid demi menciptakan peradaban yang berkualitas dan
            berakhlak mulia.
          </p>
        </div>
      </section>
      ...
      <section className="relative w-full py-20 md:py-32 bg-[#F5FCF0] overflow-hidden md:overflow-visible">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 left-0 w-full h-[60%] md:h-[45%] bg-[#D3ECC4] z-0 shadow-sm border-y border-[#C4E4B2]/80"></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6 md:px-12">
          <div className="w-full md:w-1/2 md:pr-10 py-4 md:py-8 text-center md:text-left">
            ...
            <p className="text-zinc-800 text-sm md:text-lg leading-relaxed font-medium">
              Program dakwah Taman Zakat adalah inisiatif yang bertujuan untuk
              mendukung pilar agama di pelosok daerah. Kami memastikan setiap
              sedekah dan zakat tersalurkan pada pengembangan sarana prasarana
              serta SDM pengajar sehingga nilai kebaikan terus mengalir.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Mendukung perjuangan para ustadz dan da&apos;i yang rela
                menyebarkan syiar Islam hingga ke pelosok dan daerah terpencil.
                Donasi Anda membantu menyediakan kebutuhan pokok, transportasi,
                hingga fasilitas penunjang bagi keseharian mereka.
              </p>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          <div className="w-full md:w-1/2 order-2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Masih banyak saudara muslim di pedalaman yang kesulitan
                mendapatkan mushaf Al-Quran dengan kondisi layak. Bersama Taman
                Zakat, mari hadirkan cahaya Illahi melalui sedekah Al-Quran yang
                akan dialirkan pahalanya untuk Anda.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <button className="bg-transparent border text-[#7FC248] shadow-sm px-4 py-2 md:px-5 md:py-2.5 rounded hover:bg-[#F3F9EF] transition font-semibold text-xs md:text-sm border-[#7FC248]/30">
                  Lihat Detail Program
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Menumbuhkan kecintaan para saudara mualaf terhadap Islam dengan
                memberikan pelatihan berkesinambungan dan modal usaha agar
                mereka terus mandiri dalam keyakinan yang lurus.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <div className="relative inline-block">
                  <div
