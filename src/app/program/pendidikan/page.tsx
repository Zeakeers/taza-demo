...
export default function BidangPendidikanPage() {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000/api'}/content/program_pendidikan`);
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 flex justify-center md:justify-end">
          ...
          <div className="bg-white rounded-2xl md:rounded-md w-full sm:max-w-[420px] p-5 sm:p-6 md:p-8 lg:p-10 relative border border-green-50 shadow-[15px_-10px_30px_rgba(127,194,72,0.25)] md:shadow-[25px_-15px_40px_rgba(127,194,72,0.25)] mt-12 md:mt-0">
            ...
            <h1 className="text-[26px] md:text-[32px] font-poppins font-bold text-black mb-5 mt-4 ml-6 md:ml-8 text-left drop-shadow-sm">
              {pageData ? pageData.hero_title : <>Bidang <span className="text-[#8cc63f]">Pendidikan</span></>}
            </h1>
      ...
      <section className="w-full bg-[#323232] pt-8 pb-6 border-y-8 border-[#3A3D40]">
        <div className="w-full text-center">
          <h3 className="text-white text-xl md:text-2xl font-poppins mb-8">
            {pageData?.slider_title || "Program Pendidikan - Taman Zakat"}
          </h3>
          <div
            ref={sliderRef}
          ...
          >
            {[
              ...
              >
                ...
                <Image
                  src={program.image || "/images/placeholder.png"}
                  alt={program.title}
                  fill
          ...
          <p className="text-zinc-300 text-sm md:text-base">
            {pageData?.slider_subtitle || "Berikut Program - Program Kami"}
          </p>
        </div>
      </section>
          ...
          <div className="w-full md:w-[55%] lg:w-[60%] flex flex-col gap-6 md:gap-2 mt-8 md:mt-0 items-end overflow-visible z-10 lg:pr-12 md:pr-4">
            ...
            <div className="flex flex-row justify-end items-center gap-2 md:gap-4 w-full md:w-[95%] lg:w-[85%] mt-[-10px] md:mt-[-20px]">
              ...
              <div className="w-[48%] md:w-[50%] lg:w-[48%] aspect-[4/3] rounded-sm border-[4px] md:border-[6px] border-white bg-white shadow-lg z-20 rotate-[-3deg] transition-transform hover:scale-[1.03] hover:z-[60]">
                <div className="relative w-full h-full overflow-hidden">
                  <Image
                    src={pageData?.hero_image || "/images/gambardetaile/Yatim-Beasiswa-Sekolah-Yatimn 1.svg"}
                    alt="Image 2"
                    fill
              ...
              <div className="w-[45%] md:w-[45%] lg:w-[42%] aspect-[4/3] rounded-sm border-[4px] md:border-[6px] border-white bg-white shadow-lg z-40 rotate-[2deg] transition-transform hover:scale-[1.03] hover:z-[60] mt-4 md:mt-8">
                <div className="relative w-full h-full overflow-hidden">
                  <Image
                    src={pageData?.collage_images?.[0] || "/images/gambardetaile/santri 1.svg"}
                    alt="Image 3"
                    fill
                    className="object-cover"
                  />
