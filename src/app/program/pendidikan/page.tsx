    ...
    <main className="min-h-screen w-full bg-white overflow-x-hidden font-poppins">
            ...
            <ul className="space-y-3 md:space-y-4 mb-8 md:mb-10 ml-2 md:ml-8">
              {[
                ...
                <li key={idx} className="flex items-center gap-3 md:gap-4">
                  ...
                  <span className="text-zinc-800 font-semibold text-[15px] md:text-[20px]">
                    {item}
                  </span>
                </li>
              ))}
      ...
      <section className="w-full pt-16 pb-12 px-4 md:px-12 bg-white flex justify-center text-center">
        <div className="max-w-4xl w-full">
          <h2 className="text-2xl md:text-3xl font-poppins font-bold text-black mb-6">
            Program Pendidikan
          </h2>
          <p className="text-zinc-800 text-sm md:text-lg leading-relaxed max-w-4xl font-medium mx-auto">
            Program Pendidikan Taman Zakat adalah Inisiatif yang bertujuan untuk
            membuka akses pendidikan bagi anak-anak dari keluarga prasejahtera
            agar mereka dapat belajar, berkembang, dan meraih masa depan yang
            lebih baik. Melalui program ini, Taman Zakat memprioritaskan
            penyaluran bantuan tepat sasaran seperti bantuan beasiswa,
            perlengkapan belajar, pembinaan karakter, hingga perwujudan aset
            penunjang edukasi.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-[#323232] pt-8 pb-6 border-y-8 border-[#3A3D40]">
        <div className="w-full text-center">
          <h3 className="text-white text-xl md:text-2xl font-poppins mb-8">
          ...
          >
            {[
              {
                title: "Beasiswa Bintang",
                image:
                  "/images/gambardetaile/Yatim-Beasiswa-Sekolah-Yatimn 1.svg",
              },
              {
                title: "Beasiswa Bintang",
                image: "/images/gambardetaile/santri 1.svg",
              },
              {
                title: "Beasiswa Bintang",
                image: "/images/gambardetaile/bidang pendidikan.svg",
              },
              {
                title: "Beasiswa Bintang",
                image: "/images/gambardetaile/beasiswa-santri 1.svg",
              },
              {
                title: "Beasiswa Bintang",
                image: "/images/gambardetaile/footage ambul 2 1.svg",
              },
            ].map((program, i) => (
              <div
                key={i}
                className={`relative min-w-[220px] md:min-w-[280px] h-[180px] md:h-[220px] bg-[#d9d9d9] rounded-lg shrink-0 flex items-center justify-center shadow-lg transition-transform ${isDown ? "" : "hover:scale-[1.02]"} overflow-hidden group select-none`}
              >
                ...
                <div className="absolute inset-0 flex items-center p-4 justify-center bg-black/40 group-hover:bg-black/60 transition-colors duration-300">
                  <p className="text-white font-medium text-base md:text-xl drop-shadow-md z-10 text-center">
                    {program.title}
                  </p>
                </div>
              </div>
      ...
      <section className="relative w-full py-20 md:py-32 bg-[#faf7f0] overflow-hidden md:overflow-visible">
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6 md:px-12">
          <div className="w-full md:w-1/2 md:pr-10 py-4 md:py-8 text-center md:text-left">
            <h2 className="text-2xl md:text-4xl font-poppins font-bold text-black mb-4">
              Program Pendidikan
            </h2>
            <p className="text-zinc-800 text-sm md:text-lg leading-relaxed font-medium">
              Program pendidikan Taman Zakat adalah inisiatif yang bertujuan
              untuk membuka akses pendidikan bagi anak-anak dari keluarga
              prasejahtera agar mereka dapat belajar, berkembang, dan meraih
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end">
            <div className="relative w-[90%] md:w-full max-w-[400px] aspect-[4/3] mt-6 md:mt-0">
              ...
              <div className="absolute -top-5 left-4 md:left-6 z-20 w-[24px] md:w-[28px] h-[55px] md:h-[65px]">
                <Image
                  src="/images/icon/penjepit kertas.svg"
                  alt="Penjepit Kertas"
                  fill
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                ...
                bisa menjadi bagian dari harapan—membantu melunasi biaya SPP
                anak-anak dan menghadirkan masa depan bagi saudara dhuafa yang
                sedang berjuang di masa sulit ini.
              </p>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          <div className="w-full md:w-1/2 order-2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Program Peduli Yatim dari Taman Zakat diharapkan dapat menolong
                anak yatim dan keluarga dhuafa dan anak mendapatkan kualitas
                pendidikan yang layak demi menjamin cita-cita dan pertolongan
                pertama pada pendidikan.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <button className="bg-transparent border text-[#7FC248] shadow-sm px-4 py-2 md:px-5 md:py-2.5 rounded hover:bg-[#F3F9EF] transition font-semibold text-xs md:text-sm border-[#7FC248]/30">
                  Lihat Detail Program
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Hanya dengan{" "}
                <span className="text-[#FF5B5B] font-bold">Rp 10.000</span>,
                Anda bisa menjadi bagian dari harapan – membantu melunasi biaya
                kegiatan edukasi parenting dan menghadirkan pemahaman bagi orang
                tua untuk bekal membina anak.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <div className="relative inline-block">
                  <div
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          <div className="w-full md:w-1/2 order-2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Program Infaq Guru Teladan dari Taman Zakat diharapkan dapat
                menolong guru berdedikasi tinggi demi memajukan kualitas
                pendidikan murid dan menjamin kemajuan peradaban yang
                berkualitas.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <button className="bg-transparent border text-[#7FC248] shadow-sm px-4 py-2 md:px-5 md:py-2.5 rounded hover:bg-[#F3F9EF] transition font-semibold text-xs md:text-sm border-[#7FC248]/30">
          ...
          <div className="w-full md:w-1/2 order-1 md:order-2 flex justify-center md:justify-start">
            <div className="relative w-[90%] md:w-full max-w-[400px] aspect-[4/3] mt-6 md:mt-0">
              ...
              <div className="absolute -top-[14px] md:-top-[18px] left-[20%] z-20 w-[14px] md:w-[16px] h-[35px] md:h-[45px]">
                <Image
                  src="/images/icon/penjepit majalah.svg"
                  alt="Clip"
                  fill
                  className="object-contain"
                />
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Hanya dengan{" "}
                <span className="text-[#FF5B5B] font-bold">Rp 10.000</span>,
                Anda bisa menjadi bagian dari harapan – membantu melengkapi
                sosialisasi siaga bencana dan menghadirkan bantuan bagi saudara
                dhuafa yang sedang berjuang di masa sulit ini.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <div className="relative inline-block">
                  <div
      ...
      <section className="w-full relative bg-[#FEFDF9] py-16 md:py-24 overflow-visible mt-8 md:mt-16">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4 pl-4 md:pl-12 pr-0 relative z-10">
          ...
          <div className="w-full md:w-[45%] lg:w-[40%] text-left py-12 md:py-0 px-2 md:px-0 z-20">
            <h2 className="text-white text-3xl md:text-3xl lg:text-4xl font-poppins font-bold mb-4 leading-tight drop-shadow-sm">
            ...
            <div className="relative inline-block">
              ...
              >
                <div className="relative rounded-sm bg-[#7FC248] px-5 py-2.5 md:px-6 md:py-3 shadow-md hover:bg-[#6CAE3D] transition-colors">
                  <div className="relative z-10 inline-flex items-center gap-2 text-[15px] md:text-[16px] font-semibold font-poppins text-white">
                    <span>Donasi Disini</span>
                    <Image
                      src="/images/icon/Donation.svg"
                      alt="Ikon donasi"
