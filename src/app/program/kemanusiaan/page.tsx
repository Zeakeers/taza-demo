      ...
      <section className="w-full pt-16 pb-12 px-4 md:px-12 bg-white flex justify-center text-center">
        <div className="max-w-4xl w-full">
          ...
          <p className="text-zinc-800 text-sm md:text-lg leading-relaxed max-w-4xl font-medium mx-auto">
            Program Kemanusiaan Taman Zakat adalah inisiatif yang bertujuan
            untuk meringankan beban penderitaan sesama saat menghadapi krisis
            bencana, peperangan, dan darurat air. Melalui program ini,
            pendistribusian langsung menyentuh titik terpelik baik di Palestina,
            penyediaan air bersih di daerah krisis, dan tanggap darurat bencana
            lokal.
          </p>
        </div>
      </section>
          ...
          >
            {[
              ...
              },
              {
                ...
                image: "/images/gambardetaile/bidang kemanusian.svg",
              },
            ].map((program, i) => (
              <div
                key={i}
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6 md:px-12">
          <div className="w-full md:w-1/2 md:pr-10 py-4 md:py-8 text-center md:text-left">
            ...
            <p className="text-zinc-800 text-sm md:text-lg leading-relaxed font-medium">
              Program Kemanusiaan Taman Zakat hadir sebagai bentuk dedikasi aksi
              solidaritas untuk saudara kita yang tertimpa musibah, baik krisis
              lokal maupun berskala internasional. Bantuan tersalurkan secara
              cepat, transparan, dan terarah untuk memutus penderitaan secepat
              mungkin.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Tunjukkan kepedulian Anda terhadap saudara di Palestina dengan
                mengirimkan bantuan makanan, obat-obatan, dan pemulihan tempat
                perlindungan. Sedikit dari kita sangat berarti bagi perjuangan
                mereka.
              </p>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          <div className="w-full md:w-1/2 order-2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Berbagai pelosok daerah tengah mengalami kekeringan ekstrem.
                Bersama kami, alirkan sedekah jariyah Anda untuk pembangunan
                sumur bor yang menyediakan akses air bersih menyeluruh untuk
                keseharian warga.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <button className="bg-transparent border text-[#7FC248] shadow-sm px-4 py-2 md:px-5 md:py-2.5 rounded hover:bg-[#F3F9EF] transition font-semibold text-xs md:text-sm border-[#7FC248]/30">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left">
            <div className="max-w-md">
              ...
              <p className="text-zinc-800 text-sm leading-relaxed mb-6 font-medium">
                Tanggapan sigap dalam menyalurkan bantuan kepada korban bencana
                alam di tanah air, mulai dari posko evakuasi, penyediaan
                obat-obatan hingga sandang pangan untuk memulihkan duka para
                penyintas.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                <div className="relative inline-block">
