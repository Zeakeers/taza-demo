...
export default function SekolahBintangPage() {
  ...
  return (
    <section className="min-h-screen w-full bg-white overflow-x-hidden font-poppins">
      <style
      ...
      <section
        ...
        style={{
          background: "linear-gradient(to bottom, #FAF7F0 65%, #F8EED3 65%)",
        }}
      >
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="font-poppins text-2xl font-bold leading-tight text-black md:text-3xl lg:text-4xl">
            Ikuti Infaq Pembangunan Sekolah
            <br />
            Penghafal Al&apos;Quran
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-zinc-600 md:text-base">
            Pembangunan Sekolah Penghafal Al-Quran yang diselenggarakan di
            beberapa lokasi memberikan wadah yang nyaman dan aman.
          </p>
          ...
          <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-zinc-200 shadow-lg">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 shadow-md md:h-20 md:w-20">
                <svg
                  className="h-8 w-8 text-[#7FC248] ml-1 md:h-10 md:w-10"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      <section className="w-full bg-[#FAF7F0] px-4 pt-12 pb-0 md:pt-16 md:pb-0">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="font-poppins text-xl font-bold italic text-black md:text-2xl lg:text-3xl">
            Investasi Akhirat yang tepat
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-zinc-600 md:text-base">
            Program Infaq Sekolah Penghafal Al-quran 1 M ini adalah satu-satunya
            cara yang bisa kita lakukan untuk mengurangi Pendirian membangun
            sekolah penghafal quran, Ikuti dan fokus sekolah penghafal al quran
            ini sekalikn.
          </p>
          ...
          <div className="mt-14 grid grid-cols-3 gap-5 md:gap-8 max-w-3xl mx-auto">
            ...
            <div className="relative pt-4">
              ...
              <div className="rounded-lg border border-zinc-200 bg-white px-4 pt-8 pb-5 md:px-6 md:pt-10 md:pb-7 shadow-sm transition-shadow hover:shadow-md">
                <p className="font-poppins text-base font-semibold text-black md:text-lg">
                  Rp 100.000,-
                </p>
              </div>
            </div>
            ...
            <div className="relative pt-4">
              <div
                className="absolute left-1/2 top-1 z-10 label-seesaw"
          ...
          <div className="flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="w-full md:w-1/2 bg-[#222520] px-6 py-8 md:px-8 md:py-10 flex flex-col justify-center">
              ...
              <p className="mt-3 text-sm leading-relaxed text-white/80 md:text-base">
                Salah satu mitra penyaluran Taman Zakat dalam program pendidikan
                adalah Lembaga Pendidikan Islam Annahl Taman – Sidoarjo yang
                tergolong dalam Cluster Program Taman Cendekia. Beberapa turunan
                aksi program Taman Cendekia yang telah terdistribusi adalah
                Pembangunan Sekolah Penghafal Alquran seluas 2000 m2
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full bg-[#7FC248] px-4 py-0 md:py-14">
        <div className="mx-auto max-w-3xl text-center" ref={counterRef}>
          <p className="text-white text-base font-poppins md:text-lg">
          ...
          <div className="mt-4 inline-flex items-center justify-center w-40 md:w-48 rounded-md bg-white py-4 md:py-5 shadow-md">
            <span className="text-3xl font-bold text-[#7FC248] md:text-5xl font-poppins">
              {count.toLocaleString("id-ID")}
            </span>
          </div>
          <p className="mt-4 text-white text-sm font-poppins md:text-base font-semibold">
          ...
          <div className="relative flex items-center justify-center min-h-[300px] md:min-h-[400px]">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[55%] md:w-[45%] z-10">
              <div className="rounded-lg bg-white/85 backdrop-blur-[0.5px] px-6 py-8 md:px-8 md:py-10 shadow-lg">
                <h3 className="font-poppins text-lg font-bold text-black md:text-xl text-center">
                  Mencetak Hafidz Qur&apos;an hingga Akhir Zaman
                </h3>
                <p className="mt-3 text-sm leading-relaxed text-zinc-600 md:text-base text-center">
                  Membantu meningkatkan kualitas generasi bangsa Indonesia saat
                  di usia emas mereka.
                </p>
              </div>
            </div>
      ...
      <section id="donasi" className="w-full">
        ...
        <div className="bg-[#222520] px-4 pt-12 pb-3 md:pt-20 md:pb-5">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-poppins text-lg font-bold text-white md:text-xl lg:text-3xl leading-snug">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/80 md:text-base">
              Lewat program Pembangunan Sekolah Penghafal Alquran, anda membantu
              ribuan santri cilik yang memiliki semangat menghafal alquran untuk
        ...
        <div className="relative overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #222520 50%, transparent 50%)",
            }}
          >
