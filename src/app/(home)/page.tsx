      ...
      <main>
        ...
        <section className="w-full mt-24 relative z-0 pt-16 pb-12 bg-[linear-gradient(180deg,#000000_62%,#ffffff_62%)] sm:bg-[linear-gradient(180deg,#000000_65%,#ffffff_65%)]">
          <div className="max-w-[1000px] mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-4 leading-tight text-white drop-shadow-md">
              ...
              <br className="hidden sm:block" /> a difference
            </h2>
            <p className="text-center text-sm sm:text-base text-gray-300 mb-12 max-w-4xl mx-auto opacity-90 drop-shadow-md">
              charity: water uses 100% of your donation to fund clean water
              around the world and then proves every single project you fund,
              complete with GPS coordinates and photos. Give water. Get proof.
              Every single time.
            </p>
              ...
              {[1, 2].map((card) => (
                ...
                >
                  ...
                  <div className="w-1/2 flex flex-col pt-2">
                    <span className="text-[10px] text-blue-500 font-medium tracking-widest uppercase mb-1">
                      ARTIKEL
                    </span>
                    <h3 className="text-lg md:text-xl font-bold leading-snug mb-2 text-black">
                      Daging Kurban Boleh Dicuci? Baca Dulu Dulu
                    </h3>
                    ...
                    <p className="text-xs text-black leading-relaxed line-clamp-6 font-medium">
                      Bolehkah daging kurban dicuci sebelum dimasak? Simak
                      penjelasannya lebih lengkap di sini. Daging kurban
                      merupakan salah satu momen istimewa yang paling
                      ditunggu-tunggu setiap setahun sekali. Bagi umat muslim...
                    </p>
                  </div>
                </div>
              ))}
        ...
        <section className="bg-[#FAEED3] w-full py-16 text-center shadow-inner">
          ...
          <p className="text-sm font-medium text-black mb-6">
            we&apos;ve been opening at the position under
          </p>
