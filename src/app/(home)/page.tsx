    ...
    <section className="w-full min-h-screen flex flex-col bg-white overflow-x-hidden">
      ...
      <main>
        ...
        <section className="w-full mt-24 relative z-0 pt-16 pb-12 bg-[linear-gradient(180deg,#000000_62%,#ffffff_62%)] sm:bg-[linear-gradient(180deg,#000000_65%,#ffffff_65%)]">
          <div className="max-w-[1000px] mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-4 leading-tight text-white drop-shadow-md">
              Peta Penyebaran <br className="hidden sm:block" /> Taman Zakat
            </h2>
            <p className="text-center text-sm sm:text-base text-gray-300 mb-12 max-w-4xl mx-auto opacity-90 drop-shadow-md">
              Taman Zakat berkomitmen mengelola amanah donasi Anda secara profesional dan transparan untuk menghadirkan keberkahan bagi umat di seluruh penjuru Indonesia. Setiap kontribusi Anda disalurkan langsung ke berbagai program pemberdayaan, pendidikan, kesehatan, dan kemanusiaan untuk dampak yang nyata.
            </p>
        ...
        <section className="bg-[#FAEED3] w-full py-16 text-center shadow-inner">
          ...
          <h2 className="text-3xl font-bold mb-4 text-black">Mari Menebar Manfaat Bersama</h2>
          <p className="text-sm font-medium text-black mb-6">Jadilah bagian dari gerakan kebaikan Taman Zakat untuk mewujudkan masyarakat yang lebih berdaya.</p>
