      ...
      <main>
        ...
        <section className="mt-20 px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-lg sm:text-xl font-bold uppercase tracking-widest text-[#3B7A1C]">TENTANG KAMI</h2>
        ...
        <section className="w-full mt-24 relative z-0 pt-16 pb-12 bg-[linear-gradient(180deg,#000000_62%,#ffffff_62%)] sm:bg-[linear-gradient(180deg,#000000_65%,#ffffff_65%)]">
          <div className="max-w-[1000px] mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-4 leading-tight text-white drop-shadow-md">
              Setiap Zakat Anda Mengalirkan <br className="hidden sm:block" /> Keberkahan untuk Sesama
            </h2>
            <p className="text-center text-sm sm:text-base text-gray-300 mb-12 max-w-4xl mx-auto opacity-90 drop-shadow-md">
              Taman Zakat memastikan setiap titipan kebaikan Anda tersalurkan secara tepat sasaran kepada mereka yang membutuhkan di berbagai wilayah Indonesia melalui program-program yang akuntabel dan transparan.
            </p>
        ...
        <section className="bg-[#FAEED3] w-full py-16 text-center shadow-inner">
          <p className="text-[#A2BAF5] text-xs sm:text-sm tracking-[0.3em] font-bold mb-3 uppercase">PELUANG KEBAIKAN</p>
          <h2 className="text-3xl font-bold mb-4 text-black">Bergabunglah Bersama Kami</h2>
          <p className="text-sm font-medium text-black mb-6">Mari menjadi bagian dari gerakan kebaikan untuk perubahan yang lebih baik bagi ummat.</p>
